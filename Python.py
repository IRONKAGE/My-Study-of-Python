...
# class Game:
    # def __init__(self):
        ...
        # self.bg1 = PhotoImage(file="./stickman/background-1.gif")
        # self.bg2 = PhotoImage(file="./stickman/background-2.gif")
        # self.bg3 = PhotoImage(file="./stickman/background-3.gif")
        # self.bg4 = PhotoImage(file="./stickman/background-4.gif")
        # w = self.bg1.width()
        # h = self.bg1.height()
        # count = 0
        # draw_background = 0
        ...
        # self.sprites = []
        # self.running = True
        # self.game_over_text = self.canvas.create_text(250, 100, text='ПЕРЕМОГА', state='hidden')
...
# class DoorSprite(Sprite):
    # def __init__(self, game, x, y, width, height):
        # Sprite.__init__(self, game)
        # self.closed_door = PhotoImage(file="./stickman/door-1.gif")
        # self.open_door = PhotoImage(file="./stickman/door-2.gif")
...
# g = Game()
# platform1 = PlatformSprite(g, PhotoImage(file="./stickman/platform-1.gif"), 0, 480, 100, 10)
# platform2 = PlatformSprite(g, PhotoImage(file="./stickman/platform-1.gif"), 150, 440, 100, 10)
# platform3 = PlatformSprite(g, PhotoImage(file="./stickman/platform-1.gif"), 300, 400, 100, 10)
# platform4 = PlatformSprite(g, PhotoImage(file="./stickman/platform-1.gif"), 300, 160, 100, 10)
# platform5 = MovingPlatformSprite(g, PhotoImage(file="./stickman/platform-2.gif"), 175, 350, 66, 10)
# platform6 = PlatformSprite(g, PhotoImage(file="./stickman/platform-2.gif"), 50, 300, 66, 10)
# platform7 = PlatformSprite(g, PhotoImage(file="./stickman/platform-2.gif"), 170, 120, 66, 10)
# platform8 = PlatformSprite(g, PhotoImage(file="./stickman/platform-2.gif"), 45, 60, 66, 10)
# platform9 = MovingPlatformSprite(g, PhotoImage(file="./stickman/platform-3.gif"), 170, 250, 32, 10)
# platform10 = PlatformSprite(g, PhotoImage(file="./stickman/platform-3.gif"), 230, 200, 32, 10)
